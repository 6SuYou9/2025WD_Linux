# 0 "00_select_aqiang.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "00_select_aqiang.c"
# 1 "/usr/include/2025Linux.h" 1 3 4
...
# 2 "/usr/include/2025Linux.h" 2 3 4
...
# 3 "/usr/include/2025Linux.h" 2 3 4
...
# 4 "/usr/include/2025Linux.h" 2 3 4
...
# 5 "/usr/include/2025Linux.h" 2 3 4
...
# 6 "/usr/include/2025Linux.h" 2 3 4
...
# 8 "/usr/include/2025Linux.h" 2 3 4
...
# 9 "/usr/include/2025Linux.h" 2 3 4
...
# 10 "/usr/include/2025Linux.h" 2 3 4
...
# 11 "/usr/include/2025Linux.h" 2 3 4
...
# 12 "/usr/include/2025Linux.h" 2 3 4
...
# 13 "/usr/include/2025Linux.h" 2 3 4
...
# 14 "/usr/include/2025Linux.h" 2 3 4
...
# 16 "/usr/include/2025Linux.h" 2 3 4
# 2 "00_select_aqiang.c" 2


# 3 "00_select_aqiang.c"
int main(int argc,char *argv[])
{

    
# 6 "00_select_aqiang.c" 3 4
   {if(
# 6 "00_select_aqiang.c"
   argc
# 6 "00_select_aqiang.c" 3 4
   !=
# 6 "00_select_aqiang.c"
...
# 6 "00_select_aqiang.c"
                     ;
    int fdr = open(argv[1],
# 7 "00_select_aqiang.c" 3 4
                          00
# 7 "00_select_aqiang.c"
                                  );
    int fdw = open(argv[2],
# 8 "00_select_aqiang.c" 3 4
                          01
# 8 "00_select_aqiang.c"
                                  );
    char buf[4096] = {0};
 ssize_t ret;
...
# 16 "00_select_aqiang.c" 3 4
       do { unsigned int __i; fd_set *__arr = (
# 16 "00_select_aqiang.c"
       &rdset
# 16 "00_select_aqiang.c" 3 4
...
# 18 "00_select_aqiang.c" 3 4
       ((void) (((
# 18 "00_select_aqiang.c"
       &rdset
# 18 "00_select_aqiang.c" 3 4
...
# 19 "00_select_aqiang.c" 3 4
       ((void) (((
# 19 "00_select_aqiang.c"
       &rdset
# 19 "00_select_aqiang.c" 3 4
       )->__fds_bits)[((
# 19 "00_select_aqiang.c"
...
# 19 "00_select_aqiang.c"
        ...
        select(fdr+1,&rdset,
# 22 "00_select_aqiang.c" 3 4
                           ((void *)0)
# 22 "00_select_aqiang.c"
                               ,
# 22 "00_select_aqiang.c" 3 4
                                ((void *)0)
# 22 "00_select_aqiang.c"
...
# 22 "00_select_aqiang.c"
        ...
        if(
# 24 "00_select_aqiang.c" 3 4
          ((((
# 24 "00_select_aqiang.c"
          &rdset
# 24 "00_select_aqiang.c" 3 4
...
# 24 "00_select_aqiang.c"
            ...
            ret = read(
# 26 "00_select_aqiang.c" 3 4
                      0
# 26 "00_select_aqiang.c"
                                  ,buf,sizeof(buf));
   if(ret == 0){
    ...
    break;
        ...
        if(
# 33 "00_select_aqiang.c" 3 4
          ((((
# 33 "00_select_aqiang.c"
          &rdset
# 33 "00_select_aqiang.c" 3 4
          )->__fds_bits)[((
# 33 "00_select_aqiang.c"
